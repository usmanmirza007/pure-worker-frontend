  ...
  const handleProfileSetup = () => {
    if (
      ...
      const profileData = {
        ...
        serviceImageFirst: potfolioImageObject.length
          ? potfolioImageObject[0]
          : '',
        serviceImageSecond:
          potfolioImageObject.length > 1 ? potfolioImageObject[1] : '',
        serviceImageThird:
          potfolioImageObject.length > 2 ? potfolioImageObject[2] : '',
        serviceId: '',
      };
      ...
      <ScrollView>
        ...
        <View style={{marginHorizontal: 20}}>
          ...
          <View style={{zIndex: nationalityOpen ? 0 : 2}}>
            ...
            <TextWrapper
              children="Add a Portfolio"
              isRequired={false}
              fontType={'semiBold'}
              style={{fontSize: 16, marginBottom: 13, color: colors.black}}
            />
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        setPotfolioImageObject(
                          potfolioImageObject.filter(
                            text => text?.uri !== item,
                          ),
                        );
                        setPotfolioImageUrl(
                          potfolioImageUrl.filter(text => text !== item),
                        );
                      }}>
                      <Image
                        source={images.cross}
