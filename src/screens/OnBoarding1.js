    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ flex: 1 }}>
        ...
        <View style={{ alignItems: 'center' }}>
          ...
          <Image source={images.heroPix} style={{ height: 242, width: 275, marginTop: 65 }} resizeMode='contain' />
        </View>
        <View style={{ alignItems: 'center', marginTop: 35 }}>
          <Text style={{ width: 265, color: 'white',fontSize:18 }}>
            Connecting you to trusted and verified service providers
          </Text>
        </View>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 30, marginHorizontal: 20, marginTop: 45 }}>
          ...
          <Button text={'Register'} textStyle={{ color: '#000', fontSize: 20 }} style={{ flex: 1, borderRadius: 30, height: 45, backgroundColor: colors.white }} />
